...
# ✅ Streamlit 설정
#st.set_page_config(page_title="한줄성경 | BibleAI", page_icon="speech-bubble.png", layout="centered")
st.set_page_config(page_title="한줄성경 | BibleAI", page_icon="photo-3.png", layout="centered")
...
# ✅ 타이틀 설정
st.title("한줄성경 - Bible AI Chatbot")
